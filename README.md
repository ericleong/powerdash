...
| Collection Name                        |
| -------------------------------------- |
| `x-pml:-diagrams-ud-41cooper.dgm`      |
| `meta_x-pml:-diagrams-ud-41cooper.dgm` |

#### Data Document

Each document in a collection corresponds to a successful data retrevial. For the example data retrieved above, the resulting document would be similar to this:
...
The _meta_ collection contains information about each of the fields in a data document. 
